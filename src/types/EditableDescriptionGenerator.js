...
export default class EditableDescriptionGenerator {
  ...
  async generateInitialDescription(userPrompt) {
    ...
    this.garmentType = this.description.toLowerCase().includes("pants")
      ? "pants"
      : "tshirt";
  ...
  setFabric(fabric) {
    ...
    if (validFabrics.includes(fabric.toLowerCase())) {
      ...
      throw new Error(
        `Invalid fabric. Please choose from: ${validFabrics.join(", ")}`,
      );
    }
  }
  ...
  setFit(fit) {
    ...
    if (validFits.includes(fit.toLowerCase())) {
      ...
      throw new Error(
        `Invalid fit. Please choose from: ${validFits.join(", ")}`,
      );
    }
  }

  setNeckline(neckline) {
    const validNecklines = [
      "crew",
      "v-neck",
      "scoop",
      "boat",
    ...
    if (validNecklines.includes(neckline.toLowerCase())) {
      ...
      throw new Error(
        `Invalid neckline. Please choose from: ${validNecklines.join(", ")}`,
      );
    }
  }
  ...
  setLength(length) {
    ...
    if (validLengths.includes(length.toLowerCase())) {
      ...
      throw new Error(
        `Invalid length. Please choose from: ${validLengths.join(", ")}`,
      );
    }
  }
  ...
  setRise(rise) {
    ...
    if (validRises.includes(rise.toLowerCase())) {
      ...
      throw new Error(
        `Invalid rise. Please choose from: ${validRises.join(", ")}`,
      );
    }
  }
  ...
  setCut(cut) {
    ...
    if (validCuts.includes(cut.toLowerCase())) {
      ...
      throw new Error(
        `Invalid cut. Please choose from: ${validCuts.join(", ")}`,
      );
    }
  }
  ...
  setSeams(seams) {
    ...
    if (validSeams.includes(seams.toLowerCase())) {
      ...
      throw new Error(
        `Invalid seams. Please choose from: ${validSeams.join(", ")}`,
      );
    }
  }
  ...
  setWash(wash) {
    ...
    if (validWashes.includes(wash.toLowerCase())) {
      ...
      throw new Error(
        `Invalid wash. Please choose from: ${validWashes.join(", ")}`,
      );
    }
  }
  ...
  setDistressing(distressing) {
    ...
    if (validDistressing.includes(distressing.toLowerCase())) {
      ...
      throw new Error(
        `Invalid distressing. Please choose from: ${validDistressing.join(", ")}`,
      );
    }
  }
